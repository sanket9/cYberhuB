...
export class DashboardComponent implements OnInit {
  ...
  addCategory(){    
    console.log(this.cc_name);
    if (this.cc_name != "" && this.cc_name != undefined && (this.cc_parent != "" && this.cc_parent != undefined) && (this.cc_short_name != "" && this.cc_short_name != undefined)) {
      this.showloader = true;
      let header = new Headers();
      header.set("Content-Type", "application/json");

      let data = { name: this.cc_name, org_id: this.org_code, parent_id: this.cc_parent, short_name: this.cc_short_name };
