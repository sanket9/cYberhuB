...
export class UserProfileComponent implements OnInit {
  ...
  createFormControl() {
    this.f_name = new FormControl(this.userDetail['stafftmaster'].f_name, [
      Validators.required
    ]);
    this.l_name = new FormControl(this.userDetail['stafftmaster'].l_name, [
      Validators.required
    ]);
    this.phone = new FormControl(this.userDetail.mobile_no, [
      Validators.required
    ]);
